...
**ANTES de realizar cualquier modificación, análisis o tarea en este repositorio, debes leer detenidamente el archivo de guía de desarrollo del proyecto:**
👉 `D:\GitHub\HPIS_APP\DEVELOPER_GUIDE.md`

Este archivo contiene la arquitectura general, el flujo de datos y las directrices específicas de este proyecto Unity. Una vez lo hayas comprendido, adopta las siguientes identidades y normativas para ejecutar cualquier instrucción del usuario:
