...
namespace HPIS.LLM
{
    public sealed class HpisTextToSpeechAgent : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (_tts == null) Debug.LogError("HpisTextToSpeechAgent: providerAsset must implement ITextToSpeechTask.");
